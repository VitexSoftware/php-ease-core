...
{
    /**
     * @var null|Locale Singleton is stored here
     */
     ...
     */
    public static ?string $localeUsed = null;

    /**
     * i18n files location.
     *
     * @var null|string dirpath
     */
    ...
    public static function getPreferedLocale(bool $allowCli = true)
    {
        ...
        if (\PHP_SAPI === 'cli' && $allowCli) {
            $locale = (\Ease\Shared::cfg('LANG') ?:
                (\Ease\Shared::cfg('LC_ALL') ?: null));
        } else {
     ...
     *
     * @return null|string Locale Code
     */
     ...
     */
    public static function setTextDomain($textDomain): void
    {
