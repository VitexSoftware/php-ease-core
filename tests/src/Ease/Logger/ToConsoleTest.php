 ...
 */
#[CoversClass(ToConsole::class)]
class ToConsoleTest extends ToMemoryTest
{
    protected ToConsole $toconsole;
    ...
    {
        $classname = \get_class($this->toconsole);
    ...
    {
        $this->assertEquals("\033[31mred\033[0m", $this->toconsole->set('red', 'red'));
    }
    ...
    {
        $this->assertIsInt($this->toconsole->addToLog($this, 'test'));
        $this->assertIsInt($this->toconsole->addToLog($this, 'test', 'success'));
        $this->assertIsInt($this->toconsole->addToLog($this, 'test error', 'error'));
    }
