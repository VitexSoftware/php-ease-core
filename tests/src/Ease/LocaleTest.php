...
class LocaleTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->locale = new Locale('cs_CZ', $locales, 'php-vitexsoftware-ease-core');
    }
    ...
    {
        $classname = \get_class($this->locale);
    ...
    public function testAvalilble(): void
    {
        $this->assertEquals([
            ...
            'eo' => 'Esperanto',
        ], $this->locale->availble(), 'Cannot find locales ?!? in '.Locale::$i18n);
    }
    ...
    {
        $this->assertEquals('cs', $this->locale->get2Code());
        Locale::useLocale('');
        $this->assertEquals('C', $this->locale->get2Code());
    }
    ...
    {
        $this->assertEquals('cs_CZ', $this->locale->getLocaleUsed());
    }
